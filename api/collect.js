...
export default async function handler(req, res) {
  ...
  try {
    ...
    const G = await coll(ADMIN_TOKEN, (s, l) => `${ADMIN}/gems?draw=1&start=${s}&length=${l}&search%5BfromDate%5D=${fD}&search%5BtoDate%5D=${tD}&search%5BdateTarget%5D=ISSUED_AT&search%5BqueryTarget%5D=GEM_HISTORY_SEQ&search%5Bquery%5D=`, 10000, 12);
